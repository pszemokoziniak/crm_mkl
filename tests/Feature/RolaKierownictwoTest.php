...
class RolaKierownictwoTest extends TestCase
{
    ...
    {
        $this->assertSame([1, 2, 3, 4, 5, 6], Role::values());
        ...
        // Kadry mają zakres biura, tylko rozpoznajemy je osobno przy KCP.
        $this->assertContains(Role::KADRY->value, Role::officeValues());
        $this->assertSame('Kadry', Role::KADRY->label());
    }
}
