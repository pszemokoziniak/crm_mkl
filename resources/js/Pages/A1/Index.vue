<template>
  <div>
    ...
    <pracownik-naglowek :pracownik="pracownik" tytul="A1" />
        ...
        <tbody>
          ...
          >
            <td class="border-t px-6 py-4">
              ...
              <Link v-if="!kierownik" class="text-indigo-600 hover:underline" :href="`/contacts/${contactId}/a1/${item.id}/edit`">
            ...
            <td class="border-t px-6 py-4 text-right">
              ...
              <Link
                ...
                :href="`/contacts/${contactId}/a1/${item.id}/edit`"
              >
                Edytuj
              </Link>
              <button
    ...
    <div class="sm:hidden space-y-3">
      ...
      >
        <div class="flex items-start justify-between gap-2">
          <div class="font-medium wrap-break-word">{{ item.kraj ? item.kraj.name : '—' }}</div>
