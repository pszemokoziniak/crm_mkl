<template>
  <div>
    ...
    <h1 class="mb-8 text-3xl font-bold">
      <Link class="text-indigo-400 hover:text-indigo-600" href="/contacts">A1</Link>
      ...
      <table class="w-full whitespace-nowrap">
        ...
        <tr v-for="item in a1s" :key="item.id" class="hover:bg-gray-100 focus-within:bg-gray-100">
          ...
          <td class="w-px border-t">
            <Link class="flex items-center px-4" :href="`/contacts/${contact.id}/a1/${item.id}/edit`" tabindex="-1">
