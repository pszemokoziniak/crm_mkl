...
export default {
  ...
  data() {
    return {
      zaznaczone: [],
      zgloszenie: { otwarte: false, pracownik: { id: null, nazwa: '' } },
      nowaDataKonca: '',
      form: {
  ...
  methods: {
    prowadziBudowy,
    zglos(item) {
      this.zgloszenie.pracownik = { id: item.contact.id, nazwa: `${item.contact.last_name} ${item.contact.first_name}` }
