    ...
    <table class="w-full whitespace-nowrap">
      <thead>
        <tr class="text-left font-bold">
          ...
          <th class="pb-4 pt-6 px-6 border-t hidden lg:table-cell">Kierownicy</th>
          <th class="pb-4 pt-6 px-6 border-t hidden lg:table-cell">Inżynierowie</th>
      ...
      <tbody>
        ...
        >
          ...
          <td class="border-t hidden lg:table-cell">
            <Link class="flex items-center px-6 py-4" :href="`/budowy/${organization.id}/edit`" tabindex="-1">
              <div
                v-if="organization.inzynierowie"
                class="max-w-[320px] truncate"
                :title="organization.inzynierowie"
              >
                {{ organization.inzynierowie }}
              </div>
            </Link>
          </td>
