...
<!--  <Head :title="organization.name" />-->
  ...
  <h1 class="mb-8 text-3xl font-bold">
    ...
    <p class="text-base">Dodaj narzędzia do budowy</p>
  </h1>

  <div class="max-w bg-white rounded-md shadow overflow-hidden">
    <h3 class="font-medium text-xl  p-4">Znajdź wolne narzędzia</h3>
  ...
  <div v-if="toolsFree" class="max-w">
    <FreeToolsList :toolsFree="toolsFree" :organization="organization" :start="form.start" :end="form.end"/>
  </div>

  <div class="max-w bg-white rounded-md shadow overflow-hidden my-5">
    <h3 class="font-medium text-xl  p-4">Narzędzia na budowie</h3>
