        ...
        <tbody>
          ...
          >
            <td class="border-t px-6 py-4">
              ...
              <Link v-if="!kierownik" class="text-indigo-600 hover:underline" :href="`/contacts/${contactId}/pbioz/${item.id}/edit`">
                {{ item.name || '—' }}
              </Link>
            ...
            <td class="border-t px-6 py-4 text-right">
              ...
              <Link
                ...
                :href="`/contacts/${contactId}/pbioz/${item.id}/edit`"
              >
                Edytuj
              </Link>
              <button
    ...
    <div class="sm:hidden space-y-3">
      ...
      >
        <div class="flex items-start justify-between gap-2">
          <div class="font-medium wrap-break-word">{{ item.name || '—' }}</div>
        ...
        <div v-if="!kierownik" class="mt-3 flex items-center gap-4">
          <Link class="text-sm text-indigo-600" :href="`/contacts/${contactId}/pbioz/${item.id}/edit`">Edytuj</Link>
