<template>
  <div>
    ...
    <PracownikNaglowek :contact-id="contactId" :nazwa="pracownik" tytul="Szkolenia BHP" />
      ...
      <table class="w-full whitespace-nowrap">
        <thead>
          <tr class="text-left font-bold">
            <th class="pb-4 pt-6 px-6">Rodzaj szkolenia</th>
        ...
        <tbody>
          ...
          >
            <td class="border-t px-6 py-4">
              ...
              <Link v-if="!kierownik" class="focus:text-indigo-500" :href="`/contacts/${contactId}/bhp/${item.id}/edit`">
