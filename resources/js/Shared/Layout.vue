    ...
    <div class="md:flex md:flex-col">
      <div class="md:flex md:flex-col md:h-screen">
              ...
              <dropdown class="mt-1" placement="bottom-end">
                ...
                <template #dropdown>
                  <div class="mt-2 py-2 text-sm bg-white rounded shadow-xl">
                    ...
                    <Link v-if="auth.user.owner === 1 || auth.user.owner === 2" class="block px-6 py-2 hover:text-white hover:bg-indigo-500" href="/ustawienia">Ustawienia</Link>
        ...
        <div class="md:flex md:flex-grow md:overflow-hidden">
          <main-menu class="hidden flex-shrink-0 p-12 w-56 bg-indigo-800 md:block" />
